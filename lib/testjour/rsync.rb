...
module Testjour
  ...
  class Rsync
	...
	config = YAML.load_file(file)
      ...
      "rsync -az -e \"ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no\" --delete --delete-excluded --force#{excludes} --exclude=public/images/products --exclude=*.pid #{@source_uri}/ #{@destination_uri}"
